...
<div class="container rounded bg-white mb-4">
    <div class="mt-2">
        <a style="text-decoration: none; color:black" href="{{ route('admin.user.index') }}"><img style="width: 20px" src="https://cdn-icons-png.flaticon.com/512/860/860790.png" alt="">Admin</a>
    </div>
    <div class="row">
        <div class="col-md-5 border-right">
            <form action="{{ route('admin.user.updateImage') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="d-flex flex-column align-items-center text-center p-3 py-2">
                    ...
                    @else
                        <img class="rounded-3 mt-5" width="200px" src="{{ asset($user['img_src']) }}" alt="user_img">
                    @endif
