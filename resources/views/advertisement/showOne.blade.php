                ...
                <div class="row">
                        ...
                        <article class="gallery-wrap">
                            <div class="img-wrap img-thumbnail">
                                ...
                                @if (count($photos) > 0)
                                    <a data-fslightbox="mygalley" data-type="image"
                                        href="{{ asset($photos->first()['img_src']) }}">
                            ...
                            <div class="thumbs-wrap">
                                @foreach ($photos as $photo)
                                    <a data-fslightbox="mygalley" data-type="image"
                                        href="{{ asset($photo->img_src) }}" class="item-thumb">
                    ...
                    <main class="col-lg-6">
                        <article class="ps-lg-3">
                            <div class="row">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="text-secondary">
                                        ID: <strong id='id'>{{$item->id}}</strong>
                                    </div>
                                </div>
                            </div>
                            ...
                            @if ($item->min_bid != null)
                                @include('advertisement.inc.auction', ['bids' => $bids, 'ad' => $item])
                            @else
                                @include('advertisement.inc.buy')
                            @endif
