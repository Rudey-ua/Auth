...
<div class="mb-3">
    ...
    <select style="width: 50%;height: 50px; font-size: 16px" name="painting_color" class="form-select" aria-label="Default select example">
        <option selected disabled>Выбрать</option>
...
<div class="mb-3">
    ...
    <select style="width: 50%;height: 50px; font-size: 16px" name="seats" class="form-select" aria-label="Default select example">
        <option selected disabled>Выбрать</option>
...
<?php /**PATH C:\OpenServer\domains\slando.com\resources\views/categories/cars.blade.php ENDPATH**/ ?>