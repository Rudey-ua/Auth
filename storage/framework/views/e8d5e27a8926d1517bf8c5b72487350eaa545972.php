                    ...
                    <div class="row g-0">
                        <aside class="col-xl-3 col-md-4">
                            <?php if(count($advertisement->photos) > 0): ?>
                                <a href="<?php echo e(route('advertisement.view', $advertisement->id)); ?>" class="img-wrap"> <img src="<?php echo e(asset($advertisement->photos->first()['img_src'])); ?>"> </a>
                            <?php elseif(count($advertisement->photos) == 0): ?>
                                <a href="<?php echo e(route('advertisement.view', $advertisement->id)); ?>" class="img-wrap"> <img src="https://socialistmodernism.com/wp-content/uploads/2017/07/placeholder-image.png?w=640"> </a>
                            <?php endif; ?>
                        </aside> <!-- col.// -->
                        <div class="col-xl-9 col-md-8 border-start">
                            <div class="card-body">
                                <?php if(auth()->guard()->check()): ?>
                                    ...
                                    <?php endif; ?>
                                <?php endif; ?>
                                    <a href="<?php echo e(route('advertisement.view', $advertisement->id)); ?>" class="title mb-2"><?php echo e($advertisement->title); ?></a>
