                ...
                <div class="row">
                        ...
                        <article class="gallery-wrap">
                            <div class="img-wrap img-thumbnail">
                                ...
                                <?php if(count($photos) > 0): ?>
                                    <a data-fslightbox="mygalley" data-type="image"
                                        href="<?php echo e(asset($photos->first()['img_src'])); ?>">
                                        <img height="260" src="<?php echo e(asset($photos->first()['img_src'])); ?>">
                                    </a>
                                <?php elseif(count($photos) == 0): ?>
                                    <img src="https://www.ctilogistics.com/wp-content/uploads/2012/10/500x3004.gif"
                                        alt="">
                                <?php endif; ?>
                            ...
                            <div class="thumbs-wrap">
                                <?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a data-fslightbox="mygalley" data-type="image"
                                        href="<?php echo e(asset($photo->img_src)); ?>" class="item-thumb">
                    ...
                    <main class="col-lg-6">
                        <article class="ps-lg-3">
                            ...
                            <?php if($item->min_bid != null): ?>
                                <?php echo $__env->make('advertisement.inc.auction', ['bids' => $bids, 'ad' => $item], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php else: ?>
                                <?php echo $__env->make('advertisement.inc.buy', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php endif; ?>
