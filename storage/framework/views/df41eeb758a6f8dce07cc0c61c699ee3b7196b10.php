...
<div class="container mt-4">
    <div class="mb-2">
        <a style="text-decoration: none; color:black" href="<?php echo e(URL::previous()); ?>"><img style="width: 20px"
            ...
            <div class="row">
                    ...
                    <div class="col-12 product-image-thumbs">
                        <?php if(count($photos) > 0): ?>
                            <?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="product-image-thumb active"><img src="../<?php echo e($photo['img_src']); ?>"
                ...
                <?php $__currentLoopData = $advertisement; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                                <div class="mt-4">
                                    ...
                                    <form class="mt-2" action="<?php echo e(route('charge')); ?>" method="post">
                                        ...
                                        <button style="width: 200px; height: 40px" type="submit" name="submit" value="Pay Now" class="btn btn-warning">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <a class="btn btn-primary mt-2" href="<?php echo e(route('login')); ?>">Авторизуйтесь чтобы купить</a>
                    <?php endif; ?>
            ...
            <div class="row mt-4">
                ...
                <div class="tab-content p-3" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="product-desc" role="tabpanel"
                         aria-labelledby="product-desc-tab"><?php echo e($item['description']); ?></div>
