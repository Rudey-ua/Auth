        ...
        <div class="col-md-5 border-right">
            <form action="/profile/update/image" method="post" enctype="multipart/form-data">
                ...
                <div class="d-flex flex-column align-items-center text-center p-3 py-2">
                    ...
                    <?php else: ?>
                        <img class="rounded-3 mt-5" width="200px" src="storage/<?php echo e($user['img_src']); ?>">
                    <?php endif; ?>
            ...
            <form style="margin-left: 120px;width: 420px;" method="post" action="profile/delete/image">
                <?php echo csrf_field(); ?>
                <input name="id" type="hidden" value="<?php echo e($user['id']); ?>">
                <button type="submit" class="btn btn-danger col-md-6 mt-2">Удалить аватар</button>
            </form>
        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <button onclick="check_pass()" class="btn btn-primary profile-button mt-4" type="submit">Save Profile</button>
                </form>

                <?php echo $__env->make('messages.updated', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\OpenServer\domains\auth-app\resources\views/profile.blade.php ENDPATH**/ ?>