...
<form method="GET" action="<?php echo e(route('filter')); ?>">
    ...
    <article class="filter-group">
        <header class="card-header">
            <a href="#" class="title" data-bs-toggle="collapse" data-bs-target="#collapse_aside9">
                <i class="icon-control fa fa-chevron-down"></i>
                Тип приводу
            </a>
        </header>
        <div class="collapse" id="collapse_aside9">
            <div class="card-body">
                <label class="form-check mb-2">
...
<?php /**PATH C:\OpenServer\domains\slando.com\resources\views/includes/filters/trucks.blade.php ENDPATH**/ ?>